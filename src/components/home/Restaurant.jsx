...
<section className='mb-4 wrapper fadein plans_cla d-none'>
    <div className='elem to-fade-in'>
            <div className='d-flex justify-content-center mb-sm-5  mb-4'>
                    <div className='text-center'>
                    <h5 className='mb-2 all-head-color'> {t('Meals Plans')}</h5>
                    ...
                    <div className="row justify-content-center ">
                        {
                            ...
                            plans.slice(0,3).map((data,index)=> (
                                ...
                                <div className='subscribe_cards h-100'>
                                    <div className='d-flex justify-content-center align-items-center position-relative card2 mb-3'>
                                    ...
                                    <div className=''>
                                        <h6 className='fw-bold mb-3'>{t('Serving Meals')}</h6>
                                        <div className=''>
                                            <p className='mb-2'> <img src='/static/images/Icons/_-17.png' className='icon' /> <span>Breakfast</span></p>
                                            <p className='mb-2'> <img src='/static/images/Icons/_-17.png' className='icon' /> <span>Lunch</span></p>
                                            <p className='mb-2'> <img src='/static/images/Icons/_-17.png' className='icon' /> <span>Dinner</span></p>
                                        </div>
                                    </div>
                                    {/* <div className=''>
        ...
        <div className='elem to-fade-in'>
            <div className='banner_foot  d-flex justify-content-center align-items-center text-center position-relative'>
                ...
                <div className=''>
                    ...
                    <div className=''>
                        <p className='text-light'>{t(global?.home_page?.home_newsletter_description)}</p>
                    </div>
