  ...
  return (
    <CssBaseline>
        ...
        <div className='menu_bg2 position-relative '>
            <img src={global?.contact_background_image} className='w-100' />
        <CustomContainer>
        <div className='position-absolute translate-middle top-50 '>
            ...
            <h4 className='fade-in fw-bold fs-3'>{t(global?.contact_banner_text)}</h4>
        </div>
        </CustomContainer>
        </div>
     </div>

     <div className='mb-5 mt-lg-5 mt-2'>
     <CustomContainer>
        <div className='row'>
           ...
           <div className='col-lg-6'>
                <div className='contact-margin-res me-lg-5 me-0'>

                    <div className='mb-sm-5 mb-4'>
                        <h4 className='kitchen_text'>{t(global?.contact_heading)}</h4>
                        <p className='comlplete_1'>{t(global?.contact_sub_heading)}</p>
                    </div>

                    <div className='row p-0 mb-sm-4 mb-3'>
                        <di className='mb-4'>
                            <div className=''>
                                <div >
                                ...
                                <div className=''>
                                        <p className='mb-3  contact_text'>{t('Call Us')}</p>
                                        <h5 className=''><a className='fw-bold text_color text-decoration-none'  href={`tel:+91${global?.phone}`}>{global?.phone}</a></h5>
                                    </div>
                            </div>
                                </div>
                        </di>
                        <di className='mb-4 '>
                            <div className=''>
                                ...
                                <div className=''>
                                        <p className='mb-3  contact_text'>{t('Mail Us')}</p>
                                        <h5 className=''><a className='fw-bold text_color text-decoration-none' href={`mailto:${global?.email}?subject=Subject&body=message%20goes%20here`}>{global?.email}</a></h5>
                                    </div>
                            </div>
                                </div>
                        </di>
