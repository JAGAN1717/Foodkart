...
export const AppBarStyle = styled(AppBar)(({ theme }) => ({
    // background: `${router.pathname == '/' || router.pathname == '/home' ? '#ffebf1' : '#fff' }`,
    background: `${routerCheck() ? '#ffebf1' : '#fff' }`,
...
export const NavLinkStyle2 = styled(Stack)(({ theme, languageDirection }) => ({
    color: `${theme.palette.mode === 'dark' ? '#fff' : '#000'}`,
