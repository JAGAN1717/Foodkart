...
const SecondNavbar = () => {
    ...
    const handleScroll = () => {
        ...
        if (number >= 5) {
          if (window.innerWidth < 5){
                document.getElementById("sticky22")?.classList.remove("top-shadow");
          }
          else {document.getElementById("sticky22")?.classList.add("top-shadow");}
        } else{  document.getElementById("sticky22")?.classList.remove("top-shadow");}
      };
    ...
    return (
        <>
            ...
            <section className='top-header' id='sticky22'>
            <CustomContainer>
                <Toolbar disableGutters={true}>
                    ...
                    >
                        ...
                        >
                            ...
                            <div class="offcanvas offcanvas-start" tabindex="-1" data-bs-scroll="true" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                                ...
                                <NavLinks
                                    ...
                                    headclass={'hedaerNav'}
                                />
                                    <button type='button' className='btn btn_sub mt-3' onClick={()=>router.push('/category/1?name=South+Indian')}>{t('Subscribe Now')}</button>
                                </div>
                            </div>
                        <Stack
                            direction="row"
                        ...
                        >
                            ...
                            <button type='button' className='btn btn_sub d-lg-block d-none text-truncate' onClick={()=>router.push('/category/1?name=South+Indian')}>{t('Subscribe Now')}</button>
